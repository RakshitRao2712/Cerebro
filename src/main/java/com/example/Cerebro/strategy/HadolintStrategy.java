...
@Component
public class HadolintStrategy implements DevOpsLinterStrategy {

    @Override
    public EvalResult validate(Path workspace) {
        try {
            String output = CommandRunner.runCommand(workspace, "hadolint", "Dockerfile");
